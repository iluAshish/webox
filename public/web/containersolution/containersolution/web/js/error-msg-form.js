...
var service_enquiry = document.getElementById('contanier-enquiry-modal');
if (service_enquiry) {
  // containerlist  enquiry page form validation
  document.getElementById('contanier-enquiry-modal').addEventListener('submit', function (event) {
    // Prevent the default form submission behavior
    event.preventDefault();
