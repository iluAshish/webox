                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{url(Helper::sitePrefix().'containers/gallery/'.$product_id)}}">Gallery</a></li>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <span
                                        class="caption_note">Note: Image size must be 800 x 800</span>
                                    @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
