                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{url(Helper::sitePrefix().'containers')}}">Containers</a>
                            </li>
...
@endif
                        ...
                        <div class="gloss_card-header">
                            <a href="{{url(Helper::sitePrefix().'containers/gallery/create/'.$product_id)}}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right py-0 align-middle">
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{url(Helper::sitePrefix().'containers/gallery/edit/'.$gallery->id)}}"
                                                       class="btn btn-success mr-2 tooltips" title="Edit Gallery"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="#" class="btn btn-danger mr-2 delete_entry tooltips"
                                                       title="Delete Gallery" data-url="containers/gallery/delete"
