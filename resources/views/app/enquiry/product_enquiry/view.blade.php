        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{url(Helper::sitePrefix().'enquiry/product-enquiries')}}"> Enquiry List</a></li>
                                ...
                                <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                    <div class="row">
                                        ...
                                        <div class="post col-md-6">
                                            ...
                                            <hr>
                                            <strong><i class="fas fa-wrench"></i> Container Name</strong>
                                            <p class="text-muted">{{ @$enquiry->product_id }}</p>
                                            <hr>
                                            <strong><i class="fas fa-wrench"></i>Branch Name:</strong>
                                            <p class="text-muted">{{ @$enquiry->type }}</p>
                                            <hr>
