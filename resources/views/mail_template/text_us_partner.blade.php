        ...
        <td style="border-style: solid; border-color: #00afef; border-width: 2px; width:640px;">
            <table class="container" width="640" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr align="left" valign="top">
                    <td valign="middle" colspan="5">
                        <p style="font-size:14px;line-height:22px;padding-top:15px;">Dear Admin, <br/><br/>
                            You have received a new Enquiry Request! <br/><br/></p>
                    </td>
                </tr>
                <tr align="left" valign="top">
                    <td valign="middle" colspan="5">
                        <h2 style="font-size:14px;line-height:22px;padding-top:5px;text-transform:uppercase;"><u>Here
                                Are The Request Details:</u></h2><br/>
                    </td>
                </tr>
                    ...
                    <td valign="middle" colspan="5">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left:41px;">
                            ...
                            <tr>
                                ...
                                <td style="padding:5px;font-weight:bold;">:</td>
                                <td style="padding:5px;font-weight:bold;">{email_id}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="padding:5px;font-weight:bold;">:</td>
                                <td style="padding:5px;font-weight:bold;">{company_name}</td>
                            </tr>
                            <tr>
                                <td style="padding:5px;font-weight:bold;">Industry</td>
                                <td style="padding:5px;font-weight:bold;">:</td>
                                <td style="padding:5px;font-weight:bold;">{industry}</td>
                            </tr>
                            <tr>
                                <td style="padding:5px;font-weight:bold;">Country Of Residence</td>
                                <td style="padding:5px;font-weight:bold;">:</td>
                                <td style="padding:5px;font-weight:bold;">{residence}</td>
                            </tr>
                            <tr>
                ...
                <tr align="left" valign="top">
                    <td valign="middle" colspan="5">
                        <p style="font-size:14px;line-height:22px;padding-top:25px;">Make sure to go through the given
                            enquiry details and proceed to the further stage of the response</p>
                    </td>
                </tr>
                ...
                <tr align="left" valign="top">
                    <td valign="middle" colspan="5">
                        <br/><br/>
                        <p style="font-size:14px;line-height:22px;padding-top:15px;">Thanks & Regards<br/>
                            {site_name} Web Team</p>
                        <br/><br/>
                    </td>
                </tr>
                <br/>
